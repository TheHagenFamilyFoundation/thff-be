...
<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin: 0 0 24px 0; border-radius: 8px; overflow: hidden;">
    <tr>
        <td style="background-color: #f0f9f9; padding: 16px 20px; border-left: 4px solid #008083;">
...
<p style="margin: 0; font-size: 14px; color: #94a3b8;">
    You can track the status of your proposal from your organization dashboard.
</p>`;
