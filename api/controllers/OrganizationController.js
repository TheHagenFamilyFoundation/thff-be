...
module.exports = {
  ...
  async getOrganizations(req, res) {
    try {
      ...
      sails.log.debug('filter', filter);
      sails.log.debug('sort', sort); //field name
      sails.log.debug('dir', dir); //sort direction
      ...
      //sorting
      sails.log.debug('organizations', organizations.length);
      switch (sort) {
        ...
        case 'createdOn':
          ...
          break;
        case 'name':
          // sails.log.debug('name sort');
          // organizations.forEach(org => {
          //   sails.log.debug('org.name', org.name);
          // })
          // organizations.sort(function (a, b) {
          //   // ASC  -> a.length - b.length
          //   // DESC -> b.length - a.length
